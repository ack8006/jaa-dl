...
if __name__ == '__main__':
    ...
    pred = helper_3(test_data, 'final_model_save/pre-gen-models/',
                        'convheavy_mdl1.model', 0.2105263157894737,
                        'convheavy_mdl2.model', 0.07894736842105263)
    pickle.dump(pred, open('helper_3_dump.p', 'w'))