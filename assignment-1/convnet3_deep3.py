...
def run(train_loader, valid_data, valid_label, n_examples, epochs, d1, d2, minibatch, save_label):
    torch.manual_seed(42)
    n_classes = 10
    model = ConvNet(output_dim=n_classes, dropout_1=d1, dropout_2=d2)
    ...
    with open("final_model_save/conv3deep3_{}.model".format(save_label), "w") as f:
        torch.save(model, f)
