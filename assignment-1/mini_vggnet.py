...
class ConvNet(torch.nn.Module):
    def __init__(self, output_dim, dropout=0.5):
        ...
        self.conv.add_module('conv_2', torch.nn.Conv2d(3,16, kernel_size=3, padding=1))
        self.conv.add_module("relu_2", torch.nn.ReLU())
        self.conv.add_module('conv_3', torch.nn.Conv2d(3,16, kernel_size=3, padding=1))
        self.conv.add_module("relu_3", torch.nn.ReLU())
        self.conv.add_module("maxpool_1", torch.nn.MaxPool2d(kernel_size=2))
        self.conv.add_module('conv_4', torch.nn.Conv2d(3,32, kernel_size=3, padding=1))
        self.conv.add_module("relu_4", torch.nn.ReLU())
        self.conv.add_module('conv_5', torch.nn.Conv2d(3,32, kernel_size=3, padding=1))
        self.conv.add_module("relu_5", torch.nn.ReLU())
        self.conv.add_module('conv_6', torch.nn.Conv2d(3,32, kernel_size=3, padding=1))
        ...
        #self.fc.add_module("relu_9", torch.nn.ReLU())
